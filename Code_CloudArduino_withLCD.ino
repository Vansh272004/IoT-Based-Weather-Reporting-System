/* 
  Sketch generated by the Arduino IoT Cloud Thing "CloudwithLCD"
...
void setup() {
  ...
  tcaSelect(2);     // Assume LCD is on channel 1
  lcd.init();       // Initialize LCD
  lcd.backlight();  // Turn on backlight

  // Select the channel for LTR390
  tcaSelect(6);  // Assume LTR390 is on channel 0
  if (!ltr390.init()) {
  ...
  tcaSelect(7);  // Assume BMP280 is on channel 2
...
void loop() {
  ...
  tcaSelect(6);  // Select channel 0 for LTR390
  float lux = 0;
  float uvi = 0;
  ...
  tcaSelect(7);  // Select channel 2 for BMP280
  ...
  // Select the channel for LCD
  tcaSelect(2);  // Select channel 1 for LCD
